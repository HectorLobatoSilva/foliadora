...
/**
 * ******************************************************************
 * La siguiente clase llamada "Impresora", es la encargada de * establecer la
 * fuente con que se va a imprimir, de obtener el	* trabajo de impresion, la
 * página. En esta clase hay un método	* llamado imprimir, el cual recibe una
 * cadena y la imprime.	*
*******************************************************************
 */
class Impresora {
	...
	*******************************************************************
    ...
    public void imprimir(String Cadena) {
        ...
        try {
            ...
            pagina.drawString(Cadena, 530, 800);
